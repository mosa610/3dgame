...
void Camera::SetLookAt(const DirectX::XMFLOAT3& eye, const DirectX::XMFLOAT3& focus, const DirectX::XMFLOAT3& up, const DirectX::XMFLOAT3& position)
{
    //視点、注視点、上方向からのビュー行列を作成
    DirectX::XMVECTOR Eye = DirectX::XMLoadFloat3(&eye);
    DirectX::XMVECTOR Focus = DirectX::XMLoadFloat3(&focus);
...
void Camera::SetPerspectiveFov(float fovY, float aspect, float nearZ, float farZ)
{
    ...
    near_clip_distance = nearZ;
    far_clip_distance = farZ;
